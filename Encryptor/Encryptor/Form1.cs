...
namespace Encryptor
{
    public partial class Encryptor : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Password must have 8 characters!", "Invalid Password", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if(listBox1.Items.Count > 0)
            {
                for(int num = 0; num < listBox1.Items.Count; num++)
                {
                    ...
                    if(!e_file.Trim().EndsWith(".!SecuredByDil") && File.Exists(e_file))
                    {
                        EncryptFile("" + listBox1.Items[num], "" + listBox1.Items[num] + ".!SecuredByDil", textBox1.Text);
        ...
        char[] mychar = { '!', '.', 'S', 'e', 'c', 'u', 'r', 'e', 'd' , 'B', 'y' ,'D', 'i', 'l' };
